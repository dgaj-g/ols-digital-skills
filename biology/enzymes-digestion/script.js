...
// ============================================================
const QUIZ = [
  { q: 'What type of molecule is every enzyme?', opts: ['A protein', 'A carbohydrate', 'A fat', 'A vitamin'], a: 0, ex: 'All enzymes are proteins. They act as biological catalysts.' },
  { q: 'What does an enzyme do to the rate of a reaction?', opts: ['Speeds it up', 'Slows it down', 'Stops it completely', 'Has no effect'], a: 0, ex: 'Enzymes are biological catalysts — they speed up reactions without being used up.' },
  ...
  { q: 'Protease breaks down protein into…', opts: ['Amino acids', 'Glucose', 'Fatty acids', 'Glycerol'], a: 0, ex: 'Protease digests protein into amino acids.' },
  { q: 'Lipase breaks down fats into…', opts: ['Glycerol and fatty acids', 'Glucose', 'Amino acids', 'Starch'], a: 0, ex: 'Lipase digests fats (lipids) into glycerol and fatty acids.' },
  { q: 'The substrate is described as complementary to which part of the enzyme?', opts: ['The active site', 'The membrane', 'The product', 'The nucleus'], a: 0, ex: 'The substrate fits the active site like a key in a lock — the lock-and-key model.' },
  { q: 'What happens to an enzyme above its optimum temperature?', opts: ['It denatures', 'It speeds up forever', 'It turns into a substrate', 'Nothing changes'], a: 0, ex: 'Heat changes the shape of the active site (denaturation). It is irreversible, so the substrate no longer fits.' },
  { q: 'What does an inhibitor do to an enzyme?', opts: ['Blocks the active site', 'Speeds the enzyme up', 'Becomes a product', 'Raises the temperature'], a: 0, ex: 'An inhibitor fits the active site but is not broken down, so the substrate cannot get in and the rate falls.' },
  { q: 'Digestion changes large, insoluble molecules into…', opts: ['Small, soluble molecules', 'Larger molecules', 'Enzymes', 'Proteins'], a: 0, ex: 'Small, soluble molecules can then be absorbed into the bloodstream.' },
  { q: 'Why is the ileum long and folded with millions of villi?', opts: ['To increase the surface area for absorption', 'To make more enzymes', 'To store food', 'To raise body temperature'], a: 0, ex: 'A very large surface area lets more digested food be absorbed.' },
  { q: 'Which products does the lacteal absorb?', opts: ['Glycerol and fatty acids', 'Glucose', 'Amino acids', 'Oxygen'], a: 0, ex: 'The lacteal absorbs the products of fat digestion — glycerol and fatty acids.' },
  { q: 'Why does a single layer of surface (epithelium) cells help absorption?', opts: ['It gives a short diffusion distance', 'It makes enzymes', 'It stores fat', 'It kills bacteria'], a: 0, ex: 'A thin, single layer of cells means molecules diffuse only a short distance into the blood.' }
];
const QUIZ_N = 10;
