...
(function () {
  ...
  window.GJ_CONTENT['stats-collect'] = {
    ...
    authoredNarration: [
      ...
      's1 q1/q3/q5/q6/q7/q9 to q13 claims: every claim is the pack\'s own conclusion sentence built from the source\'s printed question and its named flaw(s) — the sources print blank criticism/design lines, never a model claim to quote (same convention as Book C\'s s6)',
      ...
      'Q12 (s5 q29, engine size v distance-per-litre): DESIGN §18.1 and SOURCE_INVENTORY.md both cite this as M7 "Q12", but the physical PDF page (rendered at 200dpi, tools/qa/out/bookA/pages/p15 (page 15)) prints "Q11" on this exact question — a numbering drift in the compiled test bank after Q9/Q10 span two pages each; the dataset (engine size vs km/litre, 7 cars) is unambiguous and unaffected'
    ],
    ...
    sections: [
          ...
          { id: 'q13', kind: 'judge', marks: [1, 1], reserve: true,
            ...
            claims: [
              { text: 'Every possible amount has a box.', fair: false,
                why: 'Q_GAP', alsoWhy: ['Q_NO_ZERO'] },
              { text: 'This question does say the amount is for one week.', fair: true }
            ],
            reasons: ['Q_GAP', 'Q_NO_ZERO', 'Q_OVERLAP', 'Q_VAGUE'],
      ...
      /* ════════════════════════════════ s2 ═══════════════════════════════ */
      {
        ...
        questions: [
          ...
          { id: 'q17', kind: 'values', marks: [3, 2], reserve: true,
            prompt: 'One week at an activity centre, 90 teenagers took part in various activities, and some took part in none. 8 just did abseiling and 37 did abseiling altogether. 36 did cycling altogether. 15 did abseiling and cycling altogether. 22 did sailing and cycling altogether. 10 did all three activities and 8 did none. Fill in the missing values.',
            fig: { type: 'venn3', n: 90,
      ...
      /* ════════════════════════════════ s4 ═══════════════════════════════ */
      {
        ...
        movie: {
          ...
          src: 'Stem and leaf notes (SOURCE_INVENTORY 1.10), Example 1 (13 boys\' weights); Statistics M7 (1).pdf Q2 (coins)',
          mode: 'paper',
          steps: [
            ...
            { say: 'The range is the biggest weight minus the smallest: 9.3 − 3.4 = 5.9 g.',
              do: [{ write: { text: 'Range = 9.3 − 3.4 = 5.9 g' } }, { tick: { line: 2 } }] },
            { say: 'The mode is the value that appears most often: 7.5 g, three times.',
              do: [{ write: { text: 'Mode = 7.5 g' } }, { tick: { line: 3 } }] },
            { say: 'The median is the middle value, the 16th of 31: 6.7 g.',
              do: [{ write: { text: 'Median = 6.7 g (the 16th value)' } }, { tick: { line: 4 } }] }
          ]
        },
        questions: [
          ...
          { id: 'q27', kind: 'stemleaf', marks: [2, 1], reserve: true,
            ...
            src: 'Stem and leaf notes (SOURCE_INVENTORY 1.10), Back to Back Example 1 (press-ups)' },
          { id: 'q28', kind: 'judge', marks: [0, 1], reserve: true,
            ...
            src: 'Stem and leaf notes (SOURCE_INVENTORY 1.10), Back to Back Example 1 ("Do you think the boys were better than the girls? Why?")' }
        ]
      },
      ...
      /* ════════════════════════════════ s5 ═══════════════════════════════ */
      {
        ...
        questions: [
          ...
          { id: 'q31', kind: 'scatter', marks: [3, 2], pointsW: 2,
            ...
            src: 'Statistics M7 (1).pdf Q25; student-to-pair mapping confirmed from the page image (tools/qa/out/bookA/pages/p30 (page 30)): student 2 = (50, 5.2), student 3 = (30, 3.2) — see CONTENT_NOTES.md' },
