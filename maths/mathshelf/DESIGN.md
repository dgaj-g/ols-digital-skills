# MathShelf — OLS Maths M2 Revision Platform
...
- Platform: **MathShelf** — "every pupil's working, visible through the glass".
...
- Repo slug: `maths/mathshelf/`. Deployed name for Apps Script project: "OLS Maths — MathShelf".
...
- The static github.io build (`/maths/mathshelf/`) is the always-available offline/preview tier
