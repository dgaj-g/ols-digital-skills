          ...
          steps: [
            { say: 'The same 50 boys’ heights — this time we plot them.',
              do: [{ table: { head: ['Height (cm)', 'Frequency'],
                              rows: [['130 ≤ h < 140', '5'], ['140 ≤ h < 150', '13'],
                                     ['150 ≤ h < 160', '19'], ['160 ≤ h < 170', '10'], ['170 ≤ h < 180', '3']] } }] },
            { say: 'The upper class limits go along the bottom and the cumulative frequency goes up the side.',
            ...
            { say: '150 has a running total of 18.',
              do: [{ plot: { x: 150, y: 18 } }] },
            { say: 'Nineteen more boys are added, so the total reaches 37.',
              do: [{ plot: { x: 160, y: 37 } }] },
      ...
      /* ════════════════════════════════ s5 ═══════════════════════════════ */
      {
        ...
        movie: {
          ...
          steps: [
            ...
            { say: 'And the median, 28. Five markers make one box plot.',
            ...
            { say: 'The quartiles are 16 and 25, and the median is 20.',
