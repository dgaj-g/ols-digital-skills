/* MathShelf — Angles content pack (CCEA M2, J3 revision).
  ...
  var s6 = {
    ...
    movie: {
      ...
      steps: [
        ...
        { say: 'ANY correct route earns the marks. MathShelf marks every valid route too — pick yours.', do: [{ note: { text: 'Any valid route. Always with reasons.', red: true } }] }
      ]
    },
