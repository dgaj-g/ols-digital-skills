# MathShelf — Analytics PHASE 2 — session handover
...
- Live `/exec`: `https://script.google.com/a/macros/c2ken.net/s/AKfycbwSIylsGSFdb81u3Gz_H9IaoQUO_3OPQy7IlinUmVNByX4AQ2DLFlyLK0tbiPAoE6hA/exec`
  Live staff passcode `0lsMaths26*`. Apps Script project "OLS Maths — MathShelf" in Damien's c2ken Drive.
...
## Pointers
Full design: `maths/mathshelf/ANALYTICS_DESIGN.md`. Memory: `project_maths_glass_jotter`
