TRANSCRIPT HASH: 8b376a5135052624

_Re-filed on the steward cut, 13 Sept 2026, against this hash (was 36bfbaeacc2634c6): the transcript differs from the judged one only in the staff sentences judged by path on that cut (the Set-up gloss, the book names, the table hint — rows in MATHS_COLD_READ_VERDICTS_TEACHER.md); every row here stands verbatim._
