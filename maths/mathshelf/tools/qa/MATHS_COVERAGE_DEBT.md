...
## Seen on the steward re-cut — 11 Sept 2026, evening (three walk-right cells the POLISH tree also fails; not this cut's)

_Found by the scoped full walk of Book C at 19:38–19:47 and then reproduced on the polish tree itself with the re-cut stashed (walk B, 20:5x): the same three questions, the same way. One is a real marking fault of the live book (q17); two are reserve questions no pupil sees. The rule the TIME section wrote on 8 Sept applies — a red on an old screen is a waived row, never a fix inside another cut — and each row names its owner. Damien has the q17 finding in the steward report of 11 Sept._

| cell | reason | owner / phase | file | sha1 | waiver |
|---|---|---|---|---|---|
| stats-quartiles > s4 > q17 (cfread) @375 × walk-right | the engine's convention height for n = 50 under `split50` is (n+1)/2 = 25.5, and the rule moves in whole small squares of 2 (half a square when dragged), so 25.5 is unreachable: `RULE_median` is ✗ for every pupil and for the walker (26) — a marking fault of Book C's own since 8 Sept, NOT this cut's, reproduced on the polish tree (walk B, 11 Sept 20:5x); picture `pupil-question-checked-wrong-1-1280-q17.png`; fix = judge the rule to the grid's resolution (within half a small square, strictly) in statcore.js with selfTest rows and a dated DESIGN 4.4/6.2 correction, then the walker's rounding is right | the next Book C fix session — Book A's opening list, P0 | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s4 > q17 (cfread) @768 × walk-right | the engine's convention height for n = 50 under `split50` is (n+1)/2 = 25.5, and the rule moves in whole small squares of 2 (half a square when dragged), so 25.5 is unreachable: `RULE_median` is ✗ for every pupil and for the walker (26) — a marking fault of Book C's own since 8 Sept, NOT this cut's, reproduced on the polish tree (walk B, 11 Sept 20:5x); picture `pupil-question-checked-wrong-1-1280-q17.png`; fix = judge the rule to the grid's resolution (within half a small square, strictly) in statcore.js with selfTest rows and a dated DESIGN 4.4/6.2 correction, then the walker's rounding is right | the next Book C fix session — Book A's opening list, P0 | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s4 > q17 (cfread) @1280 × walk-right | the engine's convention height for n = 50 under `split50` is (n+1)/2 = 25.5, and the rule moves in whole small squares of 2 (half a square when dragged), so 25.5 is unreachable: `RULE_median` is ✗ for every pupil and for the walker (26) — a marking fault of Book C's own since 8 Sept, NOT this cut's, reproduced on the polish tree (walk B, 11 Sept 20:5x); picture `pupil-question-checked-wrong-1-1280-q17.png`; fix = judge the rule to the grid's resolution (within half a small square, strictly) in statcore.js with selfTest rows and a dated DESIGN 4.4/6.2 correction, then the walker's rounding is right | the next Book C fix session — Book A's opening list, P0 | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s4 > q18 (cfread) @375 × walk-right | a RESERVE question (script.js: never shown to a pupil, preview `?reserve=1` only); the walker's right route (read at 167, then key the count) fails on the polish tree too (walk B, 11 Sept 20:5x) — cause not found inside the 30-minute cap; picture `pupil-question-checked-wrong-1-768-q17.png`'s neighbour in shots/; no pupil meets this cell | next harness session | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s4 > q18 (cfread) @768 × walk-right | a RESERVE question (script.js: never shown to a pupil, preview `?reserve=1` only); the walker's right route (read at 167, then key the count) fails on the polish tree too (walk B, 11 Sept 20:5x) — cause not found inside the 30-minute cap; picture `pupil-question-checked-wrong-1-768-q17.png`'s neighbour in shots/; no pupil meets this cell | next harness session | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s4 > q18 (cfread) @1280 × walk-right | a RESERVE question (script.js: never shown to a pupil, preview `?reserve=1` only); the walker's right route (read at 167, then key the count) fails on the polish tree too (walk B, 11 Sept 20:5x) — cause not found inside the 30-minute cap; picture `pupil-question-checked-wrong-1-768-q17.png`'s neighbour in shots/; no pupil meets this cell | next harness session | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s5 > q23 (compare) @375 × walk-right | a RESERVE question (never shown to a pupil); the walker's compare route leaves sentence 1 unpressed on the polish tree too (walk B, 11 Sept 20:5x — `pupil-question-checked-wrong-1-768-q23.png`); cause not found inside the 30-minute cap; no pupil meets this cell | next harness session | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s5 > q23 (compare) @768 × walk-right | a RESERVE question (never shown to a pupil); the walker's compare route leaves sentence 1 unpressed on the polish tree too (walk B, 11 Sept 20:5x — `pupil-question-checked-wrong-1-768-q23.png`); cause not found inside the 30-minute cap; no pupil meets this cell | next harness session | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
| stats-quartiles > s5 > q23 (compare) @1280 × walk-right | a RESERVE question (never shown to a pupil); the walker's compare route leaves sentence 1 unpressed on the polish tree too (walk B, 11 Sept 20:5x — `pupil-question-checked-wrong-1-768-q23.png`); cause not found inside the 30-minute cap; no pupil meets this cell | next harness session | (any) | (any) | WAIVED BY HIS RULING 8 Sept 2026 |
