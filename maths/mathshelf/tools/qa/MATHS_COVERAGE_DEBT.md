...
_**12 Sept 2026, POLISH CUT 2:** q17's three rows are CLOSED — `statcore.js` judges a reading to the grid's resolution (|h − wantH| < sq.y/2, strictly; selfTest RD31–RD34; DESIGN §4.0 [Correction, 12 Sept 2026]), and the walker's 13 nudges (26 for 25.5) now stand on walk-right at every width. q18 and q23 stay below, dated: their routes were not investigated in this cut (the two-hour clock went on rulings 43–48), owner unchanged._
