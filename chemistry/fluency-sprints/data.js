...
window.FLUENCY_PICTOGRAMS = {
  corrosive: '<svg viewBox="0 0 100 100" class="ghs" aria-hidden="true"><polygon points="50,3 97,50 50,97 3,50" fill="#d4101a"/><polygon points="50,12 88,50 50,88 12,50" fill="#fff"/><g fill="#161616"><g transform="rotate(46 37 30)"><rect x="33" y="18" width="8" height="21" rx="3"/></g><g transform="rotate(-46 63 30)"><rect x="59" y="18" width="8" height="21" rx="3"/></g><path d="M23 45 q-2.3 3.5 0 5.8 q2.3 -2.3 0 -5.8z"/><path d="M77 45 q-2.3 3.5 0 5.8 q2.3 -2.3 0 -5.8z"/><path d="M10 67 h23 l-5 8 h-23 z"/><path d="M13 67 l2.6 -4.4 2.6 4.4 2.6 -4.4 2.6 4.4 2.6 -4.4 2.6 4.4 2.6 -4.4 2.6 4.4" fill="none" stroke="#fff" stroke-width="2.4" stroke-linejoin="round"/><path d="M60 61 q1.6 -3.2 4.2 -1 q1.1 -3.6 3.6 -1 q1.1 -3.6 3.6 -1 q1.1 -3.2 3.6 -.6 q3.1 1.1 2.6 6.2 l1.1 5.2 q1.1 5.6 -4.6 7.2 l-10.4 0 q-5.6 -1.6 -5.1 -7.2 z"/><path d="M66 65 l2.2 -3.4 2.2 3.4 2.2 -3.4 2.2 3.4" fill="none" stroke="#fff" stroke-width="2" stroke-linejoin="round"/></g></svg>',
